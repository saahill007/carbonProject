...
const UtilitiesEdit: React.FC = () => {
    ...
    useEffect(() => {
        const fetchUtilityData = async () => {
            const utilityDataPromises = utilityIdArray.map(async (utilityId) => {
                try {
                    const response = await axios.get(`${apiUrlBase}/api/utility/${utilityId}`);
            ...
            const filteredUtilityData = utilityDataResults.filter((data) => data !== null);
    ...
    const handleSave = async () => {
        if (editUtility && editUtility.Zipcode && editUtility.Country && editUtility.City && editUtility.Utility && editUtility.Utility_Value && editUtility.Utility_Units && editUtility.Sources && editUtility.Date_of_Source) {
            try {
                await axios.post(`${apiUrlBase}/api/update_utility/${editUtility.Val_Id}`, {
    ...
    return (
        <div className="utilities-edit-container">
                            ...
                            <tr key={utility.Val_Id}>
                                        ...
                                        <input
                                            ...
                                            onChange={(e) => {
                                                ...
                                                if (e.target.value === '' || re.test(e.target.value)) {
                                                  setEditUtility({ ...editUtility, Zipcode: e.target.value })
                                                }
                                              }}
                                        />
                                    ) : (
                                    ...
                                    {editUtility?.Val_Id === utility.Val_Id ? (
                                        <input
                                            ...
                                            onChange={(e) => {
                                                const re = /^[a-zA-Z\s]*$/;
                                                if (e.target.value === '' || re.test(e.target.value)) {
                                                  setEditUtility({ ...editUtility, City: e.target.value })
                                                }
                                              }}
                                        />
                                    ) : (
                                ...
                                <td>
                                    {editUtility?.Val_Id === utility.Val_Id ? (
                                        <input
                                            ...
                                            onChange={(e) => setEditUtility({ ...editUtility, Utility: e.target.value })}
                                        />
                                    ) : (
                                        utility.Utility
                                    )}
                                ...
                                <td>
                                    {editUtility?.Val_Id === utility.Val_Id ? (
                                        <input
                                            ...
                                            onChange={(e) => setEditUtility({ ...editUtility, Utility_Value: e.target.value })}
                                        />
                                    ) : (
                                ...
                                <td>
                                    {editUtility?.Val_Id === utility.Val_Id ? (
                                        <input
                                            ...
                                            onChange={(e) => setEditUtility({ ...editUtility, Utility_Units: e.target.value })}
                                        />
                                    ) : (
                                ...
                                <td>
                                    {editUtility?.Val_Id === utility.Val_Id ? (
                                        <input
                                            ...
                                            onChange={(e) => setEditUtility({ ...editUtility, Sources: e.target.value })}
                                        />
                                    ) : (
                                        utility.Sources
                                    )}
                                ...
                                <td>
                                    {editUtility?.Val_Id === utility.Val_Id ? (
                                        <input
                                            ...
                                            onChange={(e) => setEditUtility({ ...editUtility, Date_of_Source: e.target.value })}
                                        />
                                    ) : (
                                ...
                                <td>
                                    {editUtility?.Val_Id === utility.Val_Id ? (
                                        ...
                                        <button className="edit" onClick={() => handleEdit(utility)}>Edit</button>
                                    )}
                                </td>
                            </tr>
                        ))}
            ...
            <button className="back" onClick={handleUtility}>Back</button>
