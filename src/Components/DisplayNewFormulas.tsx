                      ...
                      <div className="row no-gutters">
                        <div className="col" style={{ padding: "0px 0px" }}>
                          <input
                            ...
                            style={{ height: "37px" }}
                            onChange={(e) => handleEdit(f.var1, e.target.value)}
                          />
                        </div>
                        <div className="col" style={{ padding: "0px 0px" }}>
                          <button
                      ...
                      <div className="row" style={{ padding: "0px 0px" }}>
                        <div className="col">
                          <input
                            ...
                            style={{ height: "37px" }}
                            onChange={(e) => handleEdit(f.var2, e.target.value)}
                          />
                        </div>
                        <div className="col" style={{ padding: "0px 0px" }}>
                          <button
                      ...
                      <div className="row">
                        <div className="col" style={{ padding: "0px 0px" }}>
                          <input
                            ...
                            style={{ height: "37px" }}
                            onChange={(e) => handleEdit(f.var3, e.target.value)}
                          />
                        </div>
                        <div className="col" style={{ padding: "0px 0px" }}>
                          <button
                      ...
                      <div className="row">
                        <div className="col" style={{ padding: "0px 0px" }}>
                          <input
                            ...
                            style={{ height: "37px" }}
                            onChange={(e) => handleEdit(f.var4, e.target.value)}
                          />
                        </div>
                        <div className="col" style={{ padding: "0px 0px" }}>
                          <button
