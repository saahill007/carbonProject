...
const Utilities_add: React.FC = () => {
    ...
    const handleSave = async () => {
        ...
        if (!newUtility.Zipcode || !newUtility.Country || !newUtility.City || !newUtility.Utility || !newUtility.Utility_Value || !newUtility.Utility_Units || !newUtility.Sources || !newUtility.Date_of_Source) {
        ...
        if (!existingUtility) {
            try {
                ...
                const response = await axios.post(`${apiUrlBase}/api/new_utility_add`, newUtility);
            ...
            setError("The combination of Zipcode, Utility, and Utility Units already exists. Please use a different combination.");
            return;
        }
    };
    ...
    return (
        <div className="Utilities">
                    ...
                    <td>
                        ...
                        <td>
                            <input
                                ...
                                onChange={(e) => setNewUtility({ ...newUtility, Utility: e.target.value })}
                            />
                        </td>
                        <td>
                            <input
                                ...
                                onChange={(e) => setNewUtility({ ...newUtility, Utility_Value: e.target.value })}
                            />
                        </td>
                        <td>
                            <input
                                ...
                                onChange={(e) => setNewUtility({ ...newUtility, Utility_Units: e.target.value })}
                            />
                        </td>
                        {/* <td>
                            <input
                        ...
                        <td>
                            <input
                                ...
                                onChange={(e) => setNewUtility({ ...newUtility, Sources: e.target.value })}
                            />
                        </td>
                        <td>
                            <input
                                ...
                                onChange={(e) => setNewUtility({ ...newUtility, Date_of_Source: e.target.value })}
                            />
                        </td>
                    </tr>
                </tbody>
            ...
            <button className="back_option" onClick={handleUtility}>Back</button>
