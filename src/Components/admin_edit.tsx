...
const AdminEdit: React.FC = () => {
    ...
    useEffect(() => {
        ...
        const fetchAdminData = async () => {
            ...
            const filteredAdminData = adminDataResults.filter((data) => data !== null);
    ...
    const handleSave = async () => {
        ...
        if (!emailRegex.test(editAdmin.Email)) {
            setErrorMessage("Email is not in a valid format. Please use a valid email address.");
            return;
        }
                            ...
                            <tr key={admin.admin_id}>
                                ...
                                <td>
                                    {editAdmin?.admin_id === admin.admin_id ? (
                                        ...
                                        <button className="edit" onClick={() => handleEdit(admin)}>Edit</button>
                                    )}
                                </td>
                            </tr>
                        ))}
